...
"""
Resumely — PDF Fix v2
Replaces jsPDF with a raw PDF writer that produces provably ATS-readable text.

Run from INSIDE the resumely/ folder in PowerShell:
    python fix_pdf_v2.py
"""
...
# ─────────────────────────────────────────────────────────────────────────────
# pdfExport.js — raw PDF writer, zero dependencies
# ─────────────────────────────────────────────────────────────────────────────
write("src/utils/pdfExport.js", r'''/**
...
print("\nDone. In PowerShell, run:\n")
print("  npm install")
print("  npm run dev\n")
print("The PDF now uses standard PDF Type1 fonts with real character codes.")
print("Open the PDF and try selecting text with your cursor — it will work.")
print("Then re-test in Resume Worded.")

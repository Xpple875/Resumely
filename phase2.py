#!/usr/bin/env python3
"""
Resumely — Add Enhance button to Summary field.
Run from INSIDE the resumely/ folder in PowerShell:
    python add_summary_enhance.py
"""
...
write("src/components/form/PersonalSection.jsx", """import React, { useState } from 'react'
...
# Also update ResumeForm.jsx to pass onToast to PersonalSection
write("src/components/ResumeForm.jsx", """import React from 'react'

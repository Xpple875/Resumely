            ...
            <div style={{ display: 'flex', gap: '8px', alignItems: 'center', flexWrap: 'wrap', marginBottom: '10px' }}>
               ...
               <div style={{ 
                  ...
                  <div style={{
                     ...
                     border: !PRESET_COLORS.includes(accentColor) ? '2px solid #000' : '1px solid #ddd',
                     display: 'flex',
                     alignItems: 'center',
                     justifyContent: 'center',
                     ...
                     {!PRESET_COLORS.includes(accentColor) ? (
                        <div style={{ width: '14px', height: '14px', borderRadius: '50%', backgroundColor: accentColor, border: '2px solid #fff' }} />
                     ) : (
               ...
               {PRESET_COLORS.map(color => (
                  <button
                     ...
                     style={{
                        ...
                        border: accentColor === color ? '2.5px solid #000' : '1.1px solid #ddd',
                        borderRadius: '50%',
                        cursor: 'pointer',
                        padding: 0,
                        transition: 'transform 0.1s ease',
                        boxShadow: accentColor === color ? '0 2px 6px rgba(0,0,0,0.15)' : 'none'
                     }}
                     title={color}
                  />
               ))}
